                    ...
                    <tbody>
                      @foreach ($data as $d)
                        <tr>
                          ...
                          <td class="d-flex">
                            <button class="btn btn-warning mr-2 editAdmin" data-id="{{ $d->id }}"
      ...
      <div class="modal-content">
        ...
        <form class="" id="form" method="POST" action="">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>No. HP</label>
              <input type="text" class="form-control @error('noHp') is-invalid @enderror" placeholder="No. HP" name="noHp"
                value="{{ old('noHp') }}" id="noHp">
              @error('noHp')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
