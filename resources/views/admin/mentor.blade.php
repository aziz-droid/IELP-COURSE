                    ...
                    <tbody>
                      @foreach ($data as $d)
                        <tr>
                          ...
                          <td>{{ $d->biodata }}</td>
                          <td>
                            <a href="{{ asset('uploads/mentor/' . $d->foto) }}" target="_blank"
                              rel="noopener noreferrer">
                              <img src="{{ asset('uploads/mentor/' . $d->foto) }}" alt="" style="width: 100px">
                            </a>
                          </td>
                          <td class="d-flex">
                            <button class="btn btn-warning mr-2 editMentor" data-id="{{ $d->id }}"
      ...
      <div class="modal-content">
        ...
        <form class="" id="form" method="POST" action="" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div class="form-group">
              <label>Biodata</label>
              <input type="text" class="form-control @error('biodata') is-invalid @enderror" placeholder="Biodata"
                name="biodata" id="biodata" value="{{ old('biodata') }}">
              @error('biodata')
                <div class="invalid-feedback">
                  {{ $message }}
                </div>
