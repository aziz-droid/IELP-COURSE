                    ...
                    <tbody>
                      @foreach ($data as $d)
                        <tr>
                          ...
                          <td>{{ $d->judul }}</td>
                          <td>
                            <p>{{ OEmbed::get($d->link)->data()['title'] }}</p>
                            {!! OEmbed::get($d->link)->html(['width' => 400]) !!}
                          </td>
                          <td class="d-flex">
                            <button class="btn btn-warning mr-2 editVideo" data-id="{{ $d->id }}"
        ...
        <form class="" id="" method="POST" action="">
          <div class="modal-body">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control @error('link') is-invalid @enderror" placeholder="Link Video"
                name="link" id="link">
              @error('link')
                <div class="invalid-feedback">
                  {{ $message }}
