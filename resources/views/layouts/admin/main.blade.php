          ...
          <ul class="sidebar-menu">
            ...
            <li class="nav-item dropdown {{ Request::is('admin/verif/*') ? 'active' : '' }}">
              ...
              <ul class="dropdown-menu">
                <li class="{{ Request::is('admin/verif/belum') ? 'active' : '' }}"><a class="nav-link"
                    href="/admin/verif/belum">Belum Verifikasi</a></li>
                <li class="{{ Request::is('admin/verif/sudah') ? 'active' : '' }}"><a class="nav-link"
                    href="/admin/verif/sudah">Sudah Verifikasi</a></li>
              </ul>
            </li>
            <li
