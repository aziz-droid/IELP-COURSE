              ...
              <div class="col-12">
                <div class="card card-primary">
                  <div class="card-header">
                      <button class="btn btn-icon btn-primary"><i class="fas fa-plane"></i> Admin </button><br>
                    </div>
                  <div class="card-header">
                  ...
                  <div class="table-responsive">
                      ...
                      <tbody>
                      <?php
                          $data_user=showUsers($connect,"role_id","1");
                          $no=1;
                      ...
                      ?>
                        <tr>
                          ...
                          <td><button data-toggle="modal" data-target="#ubah" data-id="<?= $data['id']?>" data-akun="admin" class="btn btn-info btn-sm"><i class="fas fa-edit"></i>Ubah</button>  <button data-toggle="modal" data-target="#hapus"  data-id="<?= $data['id']?>" data-akun="admin" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i> Hapus</button></td>
                        </tr>
                        <?php
                             }
                          ?>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <div class="row">
                  ...
                  <input id="akun" type="hidden" class="form-control" name="akun" value="admin">
